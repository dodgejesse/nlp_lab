...
The initial design lead to an accuracy of 55%. When analyzing the errors, it became evident that a significant portion of the errors came from the annotations of punctuation. There were no guidelines for how to do this, and the way i did it didn't work well. so i changed it. 
